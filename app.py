...
class GalleryPage(QWidget):
    ...
    def __init__(self, db: DatabaseManager):
        ...
        self.category_box.setPlaceholderText("Leave blank for all categories")
        self.sort_box = QLineEdit("Title")
    ...
    def refresh(self) -> None:
        ...
        category = self.category_box.text().strip() or "All"
        sort = self.sort_box.text().strip() or "Title"
...
class LoginPage(QWidget):
    ...
    def __init__(self, db: DatabaseManager):
        ...
        self.db = db
        layout = QVBoxLayout()
        layout.addWidget(QLabel("ART HUB — Login"))
        form = QFormLayout()
    ...
    def handle_login(self) -> None:
        ...
        if user:
            ...
            QMessageBox.warning(self, "Login failed", "Invalid credentials. Try admin@arthub.com / admin123 or buyer@arthub.com / buyer123")
